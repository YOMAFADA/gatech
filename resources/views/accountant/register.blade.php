    ...
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('storeaccountant') }}">
                        @csrf
                        ...
                        <!-- <div class="form-group row">
                            ...
                            <div class="col-sm-6">
              <select class="form-control" id="position" name="role_selected" required focus>
                  <option value="account"  selected>Accountant</option>        
                  <option value="manager"  selected>Manager</option>
                  <option value="staffs"  selected>Staffs</option>          
              </select>
